...
define('text!core-features/theming.css', ['module'], function(module) { module.exports = "styles.property-row {\n  margin: 24px 0;\n}\n\nstyles.label {\n  display: block;\n  margin-bottom: 16px;\n}\n"; });
