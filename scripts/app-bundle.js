...
define('swatches',["require", "exports", 'aurelia-ux'], function (require, exports, aurelia_ux_1) {
    "use strict";
...
define('text!home.html', ['module'], function(module) { module.exports = "<template>\n  <h2>Welcome</h2>\n\n  <a route-href=\"route: swatches\">Swatches</a>\n</template>\n"; });
...
define('text!swatches.html', ['module'], function(module) { module.exports = "<template>\n  <require from=\"./swatches.css#ux\"></require>\n\n  Swatches\n\n  <ux-button>Test Button</ux-button>\n\n  <div repeat.for=\"swatch of swatches\">\n    <template if.bind=\"swatch.colors\">\n      ${swatch.name}\n      <div repeat.for=\"color of swatch.colors\" css=\"background: ${color.hex}\">\n        <div>${color.name}</div>\n        <div>${color.hex}</div>\n      </div>\n    </template>\n  </div>\n</template>\n"; });
define('text!swatches.css', ['module'], function(module) { module.exports = "styles.swatch {\n\n}\n\nstyles.color {\n\n}\n\nstyles.color-name {\n\n}\n\nstyles.color-hex {\n  \n}\n"; });
define('text!scratch.html', ['module'], function(module) { module.exports = "<div repeat.for=\"color of swatch.colors\" css=\"background: ${color.hex}\">\n  <div>${color.name}</div>\n  <div>${color.hex}</div>\n</div>\n"; });
